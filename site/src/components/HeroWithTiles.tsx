    ...
    <div className={cn("relative isolate", className)}>
      ...
      >
        <div
          ...
          className={cn("aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr opacity-30", backgroundClass)}
        />
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
              ...
              <h1 className={cn("text-5xl font-semibold tracking-tight text-pretty sm:text-7xl", textColorClass)}>
                {title}
              </h1>
              {description && (
              ...
              {(primaryButton || secondaryButton) && (
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  {secondaryButton && (
                    <Link href={secondaryButton.href} className={cn("text-sm/6 font-semibold", secondaryButtonClass)}>
